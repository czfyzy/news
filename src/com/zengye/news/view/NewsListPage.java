...
//	@ViewInject(R.id.loading_view)
	...
	public NewsListPage(String url, Context context, CompletedCallBack callBack) {
		super();
	...
	public View initView() {
		...
		View view = View.inflate(context,R.layout.fragment_news_list, null);
		topNewsView = View.inflate(context,R.layout.layout_top_news_view, null);
...
//		ViewUtils.inject(topNewsView);
	...
	private void initTopNewsViewPager() {
		...
		viewPager = new RollViewPager(context, dotList, 
		...
		viewPager.setTitle(topNewsTitle,titleList);
